<script>
    ...
    onMount(() => {
        if (window.location.href.includes("/demo")) {
            ...
            timeout = setTimeout(() => {
                showModal(
                    '<div style="text-align: center">Like what you see?<br><a href="https://androz2091.fr/discord" target="_blank">Support us by saying hello and sharing your stats in our Discord server!<a></div>'
                );
            }, 10000);
        } else navigate("/");
    });
        ...
        <div class="cards">
            ...
            <Card name="first">
                ...
                <FunFact
                    ...
                    explanation="That's about {$data.averageMessageCountPerDay &&
                        $data.averageMessageCountPerDay.toLocaleString(
                            'en-US'
                        )} messages per day!"
                />
                <FunFact
                    ...
                    explanation="You are opening Discord ~{$data.averageOpenCountPerDay &&
                        $data.averageOpenCountPerDay.toLocaleString(
                            'en-US'
                        )} times per day!"
                />
            </Card>
                ...
                >
                    <div slot="content">
                        <h3>
                            ...
                            <span
                                class="text-discord"
                                on:click={$data.payments.list.length
                                    ? showModal(
                                          `<h3 style="text-align: center">${$data.payments.list}</h3>`
                                      )
                                    : undefined}
                            >
                                ${parseInt($data.payments.total).toLocaleString(
                                    "en-US"
                                )}
                            </span>
                            on Discord
                ...
                >
                    <h3 slot="content">
                        ...
                        <span class="text-discord"
                            ><SvelteTooltip
                                tip="Used {$data.favoriteWords[0].count.toLocaleString(
                                    'en-US'
                                )} times"
                                bottom
                                color="#000000"
                                ><span class="text-discord"
                                    >{$data.favoriteWords[0].word}</span
                                ></SvelteTooltip
                            ></span
                        >
                        ,
                        <span class="text-discord"
                            ><SvelteTooltip
                                tip="Used {$data.favoriteWords[1].count.toLocaleString(
                                    'en-US'
                                )} times"
                                bottom
                                color="#000000"
                                >{$data.favoriteWords[1].word}</SvelteTooltip
                            ></span
                        >
                        ,
                        <span class="text-discord"
                            ><SvelteTooltip
                                tip="Used {$data.favoriteWords[2].count.toLocaleString(
                                    'en-US'
                                )} times"
                                bottom
                                color="#000000"
                                >{$data.favoriteWords[2].word}</SvelteTooltip
                            ></span
                        >
                        and
                        <span class="text-discord"
                            ><SvelteTooltip
                                tip="Used {$data.favoriteWords[3].count.toLocaleString(
                                    'en-US'
                                )} times"
                                bottom
                                color="#000000"
                                >{$data.favoriteWords[3].word}</SvelteTooltip
                            ></span
                        >
                    </h3>
                </FunFact>
            ...
            <Card name="hours">
                ...
                <p>
                    {hoursLabels[
                        $data.hoursValues.indexOf(
                            Math.max(...$data.hoursValues)
                        )
                    ]} is definitely your favorite hour to chat with your friends!
                </p>
                <Chart
                    data={{
                        labels: hoursLabels,
            ...
            <Card name="third">
                ...
                <FunFact
                    ...
                    explanation="That's ~{Math.round(
                        $data.channelCount / $data.guildCount
                    )} per guild!"
                />
            </Card>
            <Card name="top-users">
                    ...
                    {#each $data.topDMs as channel, i}
                        <LeaderboardItem
                            ...
                            avatarURL={generateAvatarURL(
                                channel.userData.avatar,
                                channel.userData.id,
                                channel.userData.discriminator
                            )}
            ...
            <Card name="about">
                <div style="text-align: center;">
                    ...
                    <p>
                        Discord Data Package Explorer is a free, ad-free and <a
                            href="https://github.com/Androz2091/discord-data-package-explorer"
                            target="_blank"
                            class="text-discord"
                            style="text-decoration: none;">open source</a
                        > website made with Svelte.
                    </p>
                    <p>
                        These are all the developers who contributed to the
                        creation of DDPE!
                    </p>
                </div>
                    ...
                    {:catch users}
                        <SvelteTooltip tip="Androz2091" bottom color="#000000">
                            <a href="https://github.com/Androz2091">
                                <div
                                    class="contributors-item"
                                    style="background-image: url('https://avatars.githubusercontent.com/u/42497995?s=460&u=86b6310688c5e05140c6d12902d878cacdcf93db&v=4');"
                                />
                            </a>
                        </SvelteTooltip>
                    {/await}
